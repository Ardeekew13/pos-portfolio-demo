...
import logo from "@/public/cart-logo.svg";
			...
			{isMobile ? (
				...
				>
					...
					>
						...
						<span style={{ display: isTablet ? "none" : "inline" }}>POS SYSTEM</span>
					</div>
					<Menu
				...
				{isMobile && (
					...
					>
						<div style={{ display: "flex", alignItems: "center", gap: 12 }}>
							...
							<Typography.Text strong style={{ fontSize: 14 }}>POS SYSTEM</Typography.Text>
						</div>
